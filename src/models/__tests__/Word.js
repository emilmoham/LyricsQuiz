...
test.each([
    [
        { text: "Word", separator: '-' }, 
        { revealedText: 'Word', hiddenText: '____', logicalText: 'word', separator:'-' }
    ],
    [
        { text: "(Parenthetical)", separator: ' ' }, 
        { revealedText: '(Parenthetical)', hiddenText: '(_____________)', logicalText: 'parenthetical', separator:' ' }
    ],
    [
        { text: "lingüístico", separator: '-' },
        { revealedText: 'lingüístico', hiddenText: '___________', logicalText: 'linguistico', separator:'-' }
    ],
    [
        { text: "365", separator: '-' },
        { revealedText: '365', hiddenText: '___', logicalText: '365', separator:'-' }
    ],
...
test.each([
    [
        '[Word]', 
        { revealedText: '[Word]', hiddenText: '[Word]', logicalText: '[Word]', separator: '' }
    ],
    [
        '[Multiple Words]', 
        { revealedText: '[Multiple Words]', hiddenText: '[Multiple Words]', logicalText: '[Multiple Words]', separator: '' }
    ],
